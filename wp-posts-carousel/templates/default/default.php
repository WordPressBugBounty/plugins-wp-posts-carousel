<?php
/**
 * Plugin Name: Default Template for WP Posts Carousel
 * Plugin URI: https://coolcatideas.com/products/wp-posts-carousel-all-in-one
 * Description: Free, default template
...
if ( ! class_exists( 'WP_Posts_Carousel_Default_Template' ) ) :

/**
 * WP_Posts_Carousel_Default_Template class
 */
class WP_Posts_Carousel_Default_Template extends WP_Posts_Carousel_Template {
...
return WP_Posts_Carousel_Default_Template::get_instance();
endif;
